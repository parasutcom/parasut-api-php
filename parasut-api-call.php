<?php
  ...
  const AUTHORIZATION_ENDPOINT = 'https://parasut.com/oauth/authorize';
  const TOKEN_ENDPOINT         = 'https://parasut.com/oauth/token';
  ...
  else
  {
    ...
    // example api call
    $response = $client->fetch('https://parasut.com/api/v1/me');
    ...
    $response = $client->fetch('https://parasut.com/api/v1/33/sales_invoices');
    var_dump($response, $response['result']);
  }
  die;
